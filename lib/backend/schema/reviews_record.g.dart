...
class _$ReviewsRecord extends ReviewsRecord {
  ...
  _$ReviewsRecord._({this.description, this.ref, this.title, this.ffRef})
      : super._();
  ...
  int get hashCode {
    return $jf($jc(
        $jc($jc($jc(0, description.hashCode), ref.hashCode), title.hashCode),
        ffRef.hashCode));
  }
  ...
  _$ReviewsRecord _build() {
    final _$result = _$v ??
        new _$ReviewsRecord._(
            description: description, ref: ref, title: title, ffRef: ffRef);
    replace(_$result);
    return _$result;
  }
}
